...
engine = col1.slider("Set the engine power (cc):", 700, 5000, step=100)
...
if st.button("Get Price"):
    ...
    input_data = [
        model_year, encoded_seller_type, km_driven, encoded_fuel_type,
        encoded_transmission_type, engine, max_power, mileage, seats
    ]
