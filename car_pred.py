...
engine = col2.slider("Set the engine power/Displacement (CC):", 700,5000, step=100)
...
year = col3.selectbox("Select the year:",list(range(2010, 2022)))
mileage =  col2.slider("Select the mileage:", 8,120, step=1)
